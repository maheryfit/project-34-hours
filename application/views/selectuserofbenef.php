        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="login.html"><i class="far fa-user-circle"></i><span>Gestion Bénéficiaires</span></a></li>
                    </ul>
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Recherche par employe</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <form class="user" method="GET" action="testusertobenef">
                                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                                <label class="form-label">Nom&nbsp;
                                                    <select name = "iduser" class="d-inline-block form-select form-select-sm">
                                                        <?php 
                                                            
                                                            for ($i=0; $i < sizeof($data); $i++) 
                                                            { ?>
                                                            <option value="<?php echo $data[$i]['id_utilisateur']; ?>" selected="">
                                                                <?php echo $data[$i]['nom']; ?>
                                                            </option>
                                            ...
                                            </div><button class="btn btn-primary d-block btn-user w-100" type="submit">Rechercher les beneficiaires</button>
                                            <hr>
                                    </form>
