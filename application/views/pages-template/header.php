        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-3">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link text-uppercase" href="#">Gestion d'échange</a></li>
                    <li class="nav-item"><a class="nav-link text-uppercase" href="#">Listes des objets</a></li>
                </ul>
